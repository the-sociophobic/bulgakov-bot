  ...
  return (
    <ChapterLayout
      ...
      description={!ticketShown ?
        ...
        :
        `Сейчас вы увидите печатную машинку Михаила Булгакова. Зайдите в Музей истории Владикавказа, покажите билет сотруднику музея. Он сопроводит вас к экспонату.`
      }
      navigations={[
        {
