  ...
  return (
    <ChapterLayout
      ...
      description={`
        ...
        Помогите собрать чемодан Михаилу Булгакову. Можно взять всего три вещи. Нажмите на вещь и она переместится в чемодан.
      `}
      navigations={[
        {
          title: !canProceed ? 'Соберите 3 предмета в чемодан' : 'ЧЕМОДАН СОБРАН! ПОЕХАЛИ!',
          disabled: !canProceed,
          goToMove: canProceed
        }
      ]}
